...
### Q-11-001 [REQUIRED]
**Question:** What is the team composition and capacity for UX design and frontend implementation work?
**Why we need this:** The sprint plan for UX improvements (error recovery framework, onboarding wizard, cognitive load reduction) assumes a placeholder team. Actual team composition determines realistic delivery timelines.
